...
SELECT * FROM "accounts" WHERE "username" LIKE '%i%';
...
UPDATE "accounts" SET "transactions_attempted" = 10.00 WHERE "transactions_attempted" = 0;
...
VALUES ('david', 'minneapolis', 5, 5, 100.00);
...
DELETE FROM "accounts" WHERE "city" LIKE 'Miama' || 'Phoenix' AND "transactions_completed" < 5;
